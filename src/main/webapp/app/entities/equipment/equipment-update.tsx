...
export const EquipmentUpdate = (props: IEquipmentUpdateProps) => {
  ...
  const { equipmentEntity, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="pucApp.equipment.home.createOrEditLabel">Create or edit a Equipment</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : equipmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="equipment-name" type="text" name="name" />
              </AvGroup>
