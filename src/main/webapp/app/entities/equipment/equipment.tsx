...
export const Equipment = (props: IEquipmentProps) => {
  ...
  const { equipmentList, match, totalItems } = props;
  return (
    <div>
      ...
      <div className="table-responsive">
        {equipmentList && equipmentList.length > 0 ? (
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${equipment.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${equipment.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          <div className="alert alert-warning">No Equipment found</div>
        )}
      </div>
