    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            <TextFormat value={taskEntity.start} type="date" format={APP_DATE_FORMAT} />
          </dd>
          <dt>
            <span id="end">End</span>
          </dt>
          <dd>
            <TextFormat value={taskEntity.end} type="date" format={APP_DATE_FORMAT} />
          </dd>
          <dt>Sector</dt>
          <dd>{taskEntity.sector ? taskEntity.sector.name : ''}</dd>
        </dl>
