            ...
            <tbody>
              {taskList.map((task, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={task.start} format={APP_DATE_FORMAT} />
                  </td>
                  <td>
                    <TextFormat type="date" value={task.end} format={APP_DATE_FORMAT} />
                  </td>
                  <td>{task.sector ? <Link to={`sector/${task.sector.id}`}>{task.sector.name}</Link> : ''}</td>
